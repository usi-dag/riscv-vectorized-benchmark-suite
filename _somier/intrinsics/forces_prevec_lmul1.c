...
//        gvl = __builtin_epi_vsetvl(n - 1 - k, __epi_e64, __epi_m1);
        ...
        _MMR_f64 v_xs = _MM_LOAD_f64(&X[0][i][j][k - 1]);// _MM_VSLIDEDOWN_f64(v_x, 1`, gvl`) ;
        _MMR_f64 v_ys = _MM_LOAD_f64(&X[1][i][j][k - 1]);// _MM_VSLIDEDOWN_f64(v_y, 1, gvl) ;
        _MMR_f64 v_zs = _MM_LOAD_f64(&X[2][i][j][k - 1]);// _MM_VSLIDEDOWN_f64(v_z, 1, gvl) ;
        ...
        v_xs = _MM_LOAD_f64(&X[0][i][j][k + 1]);// _MM_VSLIDEUP_f64(v_x, 1, gvl) ;
        v_ys = _MM_LOAD_f64(&X[1][i][j][k + 1]);// _MM_VSLIDEUP_f64(v_y, 1, gvl) ;
        v_zs = _MM_LOAD_f64(&X[2][i][j][k + 1]);// _MM_VSLIDEUP_f64(v_z, 1, gvl) ;
